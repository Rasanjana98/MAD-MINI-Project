...
public class TeacherAppoinmentsActivity extends AppCompatActivity {
    ...
    private void showAppointments(final List<Appoinment> appoinments){
        ...
        for (int i=0; i < appoinments.size(); i++) {
            ...
            TableRow tr =  new TableRow(TeacherAppoinmentsActivity.this);
            TextView c1 = new TextView(TeacherAppoinmentsActivity.this);
            c1.setText(formatter.format(appoinment.getDate()));
            TextView c2 = new TextView(TeacherAppoinmentsActivity.this);
            c2.setText(appoinment.getLocation());
            TextView c3 = new TextView(TeacherAppoinmentsActivity.this);
            ...
            c4.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    teacher.setAppoinments(appoinments);
